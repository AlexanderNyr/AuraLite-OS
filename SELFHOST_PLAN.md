...
in-tree driver and gate are scaffold-complete and statically verified, but the
closure boot has not been executed in this session, so the receipt strings are
