#!/usr/bin/env bash
# tests/integration/a64_boot_smoke.sh -- ARM64_PLAN A0 smoke test.
#
...
assert_grep "$LOG" "A0 stub complete; powering off via PSCI"       "reached the healthy end of the stub"
