...
group_re() {
    case "$1" in
        ...
        net)   echo '^test_(networking|dns_cache|dns_tcp|ip_frag|e1000_irq|virtio_net|udp_sockets|http_get|http_x6|tcp_server|tcp_x5|tcp_options|ipv6_ping6|trust_store|rng|crypto|tls|x2_https|x509|gbrowser_net)$' ;;
