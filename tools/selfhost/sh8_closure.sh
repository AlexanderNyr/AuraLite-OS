...
#       compiled by tcc0 -> linked by aulink to /fat/tcc1; tcc1 then compiles
#       the same tcc sources -> aulink links /fat/tcc2.  Each binary is hashed
...
#       (/fat/kernel_build.sh) compiles all 126 C + 9 asm x86_64 kernel sources
...
# /fat/kernel_build.sh (host-generated data from the SH5d source list).
...
run /bin/tcc -nostdlib -static -o /fat/aulink /tmp/sh8/lib/crt0.o /tmp/sh8/lib/c.o /tmp/sh8/lib/bi.o /tmp/sh8/lib/m.o /tmp/sh8/lib/e.o /tmp/sh8/lib/s.o /tmp/sh8/lib/u.o /tmp/sh8/lib/io.o /tmp/sh8/lib/d.o /tmp/sh8/aulink.o /apps/tcc/libtcc1.a
run /bin/tcc -nostdlib -static -o /fat/mini-asm /tmp/sh8/lib/crt0.o /tmp/sh8/lib/c.o /tmp/sh8/lib/bi.o /tmp/sh8/lib/m.o /tmp/sh8/lib/e.o /tmp/sh8/lib/s.o /tmp/sh8/lib/u.o /tmp/sh8/lib/io.o /tmp/sh8/lib/d.o /tmp/sh8/mini.o /apps/tcc/libtcc1.a
...
run /fat/mini-asm -f elf64 -I/src -o /tmp/sh8/libcobj/setjmp.o /src/libc/crt/setjmp.asm
...
run /fat/aulink -T /src/libc/user.ld -o /fat/tcc1 /tmp/sh8/libcobj /tmp/sh8/tccobj /apps/tcc/libtcc1.a
run /bin/sha256sum /fat/tcc1
...
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/tcc.o /src/tcc/tcc.c
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/libtcc.o /src/tcc/libtcc.c
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/tccpp.o /src/tcc/tccpp.c
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/tccgen.o /src/tcc/tccgen.c
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/tccdbg.o /src/tcc/tccdbg.c
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/tccelf.o /src/tcc/tccelf.c
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/tccasm.o /src/tcc/tccasm.c
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/x86_64-gen.o /src/tcc/x86_64-gen.c
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/x86_64-link.o /src/tcc/x86_64-link.c
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/i386-asm.o /src/tcc/i386-asm.c
run /fat/tcc1 -c -DONE_SOURCE=0 -DCONFIG_TCC_STATIC -ffreestanding -fno-stack-protector -fno-pie -fno-pic -I/src/tcc -I/src/tcc/include -I/src/libc/include -o /tmp/sh8/tccobj/tcc_glue.o /src/tcc/tcc_glue.c
run /fat/aulink -T /src/libc/user.ld -o /fat/tcc2 /tmp/sh8/libcobj /tmp/sh8/tccobj /apps/tcc/libtcc1.a
run /bin/sha256sum /fat/tcc2
...
run /fat/tcc1 -c -I/src/libc/include -o /tmp/sh8/gen_asm_offsets.o /src/selfhost/gen_asm_offsets.c
run /fat/tcc1 -c -I/src/libc/include -o /tmp/sh8/gen_user_binary.o /src/selfhost/gen_user_binary.c
run /fat/tcc1 -c -I/src/libc/include -o /tmp/sh8/gen_ap_trampoline_inc.o /src/selfhost/gen_ap_trampoline_inc.c
run /fat/tcc1 -nostdlib -static -o /fat/gen_asm_offsets /tmp/sh8/lib/crt0.o /tmp/sh8/lib/c.o /tmp/sh8/lib/bi.o /tmp/sh8/lib/m.o /tmp/sh8/lib/e.o /tmp/sh8/lib/s.o /tmp/sh8/lib/u.o /tmp/sh8/lib/io.o /tmp/sh8/lib/d.o /tmp/sh8/gen_asm_offsets.o /apps/tcc/libtcc1.a
run /fat/tcc1 -nostdlib -static -o /fat/gen_user_binary /tmp/sh8/lib/crt0.o /tmp/sh8/lib/c.o /tmp/sh8/lib/bi.o /tmp/sh8/lib/m.o /tmp/sh8/lib/e.o /tmp/sh8/lib/s.o /tmp/sh8/lib/u.o /tmp/sh8/lib/io.o /tmp/sh8/lib/d.o /tmp/sh8/gen_user_binary.o /apps/tcc/libtcc1.a
run /fat/tcc1 -nostdlib -static -o /fat/gen_ap_trampoline_inc /tmp/sh8/lib/crt0.o /tmp/sh8/lib/c.o /tmp/sh8/lib/bi.o /tmp/sh8/lib/m.o /tmp/sh8/lib/e.o /tmp/sh8/lib/s.o /tmp/sh8/lib/u.o /tmp/sh8/lib/io.o /tmp/sh8/lib/d.o /tmp/sh8/gen_ap_trampoline_inc.o /apps/tcc/libtcc1.a
...
#   loop 1  compile= /fat/tcc1   loop 2  compile= /fat/tcc2
