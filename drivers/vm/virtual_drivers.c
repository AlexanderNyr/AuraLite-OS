...
static const struct known_pci_device known[] = {
    ...
    {0x8086, 0x10d3, "Intel 82574L e1000e", "e1000e", "RESIDUE2 T6: data path"},
    {0x1022, 0x2000, "AMD PCnet-PCI II / Am79C970A", "pcnet32", "known / no data path"},
    {0x10ec, 0x8139, "Realtek RTL8139/8139C/8139D", "rtl8139", "active"},
    {0x10ec, 0x8138, "Realtek RTL8139B CardBus", "rtl8139", "active"},
    {0x10ec, 0x8100, "Realtek RTL8100", "rtl8139", "active"},
    {0x10ec, 0x8130, "Realtek RTL8139C+/8130", "rtl8139", "active"},
    {0x10ec, 0x8168, "Realtek RTL8168/8111 Gigabit", "r8169", "host-model data path"},
    {0x10ec, 0x8169, "Realtek RTL8169 Gigabit", "r8169", "host-model data path"},
    {0x15ad, 0x07b0, "VMware VMXNET3", "vmxnet3", "RESIDUE2 T6: data path"},
