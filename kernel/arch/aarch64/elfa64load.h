/* kernel/arch/aarch64/elfa64load.h -- ELF64 user-program loader
 * (ARM64_PLAN A5c).
 *
...
#ifndef AURALITE_ARCH_AARCH64_ELFA64LOAD_H
#define AURALITE_ARCH_AARCH64_ELFA64LOAD_H

#include <stdint.h>

/* Segments must live in [ELF_A64_USER_MIN, ELF_A64_USER_MAX). */
#define ELF_A64_USER_MIN 0x08000000UL
#define ELF_A64_USER_MAX 0x40000000UL
...
#endif /* AURALITE_ARCH_AARCH64_ELFA64LOAD_H */
